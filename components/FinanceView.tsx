...
const FinanceView: React.FC = () => {
  ...
  const data = [
    { name: t('revenue'), value: totalRevenue, color: '#4f46e5' },
    { name: t('commissions'), value: totalCommissions, color: '#a855f7' },
    { name: t('expenses'), value: totalRevenue * 0.4, color: '#ec4899' },
  ];

  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold tracking-tight">{t('financial_overview')}</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-zinc-900/50 border border-zinc-800 p-8 rounded-3xl relative overflow-hidden group">
            ...
            <p className="text-zinc-500 text-sm font-medium">{t('total_revenue')}</p>
          ...
          <div className="bg-zinc-900/50 border border-zinc-800 p-8 rounded-3xl">
            <p className="text-zinc-500 text-sm font-medium">{t('commissions')}</p>
        ...
        <div className="lg:col-span-2 bg-zinc-900/50 border border-zinc-800 p-8 rounded-3xl">
          <h3 className="text-lg font-bold mb-8">{t('monthly_performance')}</h3>
          ...
          <div className="mt-8 pt-8 border-t border-zinc-800">
            <h4 className="text-sm font-bold text-zinc-400 uppercase tracking-widest mb-6">{t('recent_activities')}</h4>
